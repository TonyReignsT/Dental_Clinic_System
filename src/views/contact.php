...
<body>
    ...
    <section class="contact-body">
        <h2>Contact Our Dentistry</h2>
        <p>Consultation for only 1,000!</p>
        <a href="../../src/views/appointments/Appointments.php" class="this-btn">Book Appointment</a><br>
        <section>
            <div class="contact-row">
                <div class="contact-col">
                    <h3 class="contact-head">Talk To Us</h3>
                    <p>0712345678</p>
                    <p>0118765432</p>
                    <p>reignsdentalclinic@gmail.com</p>
                </div>
                <div class="contact-col">
                    <h3 class="contact-head">Syokimau Office</h3>
                    <p>Twins Centre,<br> Katani Road, <br>Third Floor</p>
