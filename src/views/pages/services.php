                            ...
                            <?php if ($result->num_rows > 0) : ?>
                                <?php while ($row = $result->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <?php endforeach; ?>
                                        <td><a href="../pages/action_btns/edit.php?id=<?= $row['service_id'] ?>" class="btn btn-sm btn-primary">Edit</a> <a href="../pages/action_btns/delete.php?id=<?= $row['service_id'] ?>" class="btn btn-sm btn-danger">Delete</a></td>
                                    </tr>
                                <?php } ?>
                            <?php endif ?>
                        </tbody>
