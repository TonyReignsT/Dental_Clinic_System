...
<div class="">
    ...
    <div class="main">
        ...
        <div class="cardBox">
            <a href="rec_patients.php" style="text-decoration:none">
                <div class="card">
                    <div>
                    ...
                    <!-- <div class="fa-light fa-users-medical">
                        <ion-icon name="eye-outline"></ion-icon>
                    </div> -->
                </div>
            </a>

            <a href="rec_services.php" style="text-decoration:none">
                <div class="card">
                    <div>
            ...
            <a href="rec_appointments.php" style="text-decoration:none">
                <div class="card">
                    <div>
            ...
            <a href="rec_payments.php" style="text-decoration: none;">
                <div class="card">
                    <div>
                        <div class="numbers">Ksh. 70,842</div>
                        <div class="cardName">Total Revenue</789p--pdiv>
                    </div>
...
<!-- =========== Scripts =========  -->
<script src="../../../../../../public/js/dash2.js"></script>
