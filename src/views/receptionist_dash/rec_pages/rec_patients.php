    ...
    <div class="main">
        ...
        <div class="d-flex justify-content-center flex-column align-items-center m-5 ">
            ...
            <div class="w-75 shadow-sm card p-3 m-2">
                ...
                <table id="rec_patients-table" border='1' class='table table-bordered'>
                    <thead>
                        <tr>
                        ...
                        <?php if ($result->num_rows > 0) : ?>
                            <?php while ($row = $result->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <?php endforeach; ?>
                                    <td><a href="../../pages/pat_actions_btns/edit_p.php?= $row['pat_id'] ?>" class="btn btn-sm btn-primary">Edit</a> <a href="../../pages/pat_actions_btns/delete_p.php?id=<?= $row['pat_id'] ?>" class="btn btn-sm btn-danger">Delete</a></td>
                                </tr>
                            <?php } ?>
                        <?php endif ?>
                    </tbody>
        ...
        <script>
            $(document).ready(function() {
                $('#searchInput').on('input', function() {
                    ...
                    $.ajax({
                        url: 'search_p.php', // Replace with the actual PHP script handling the search
                        method: 'GET',
                        data: {
                            search: search
                        },
